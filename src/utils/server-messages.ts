...
export const serverMessages = {
  ...
  'auth': {
    ...
    'userIsNotAdmin': {
      'pt-BR': 'Login invalido. Usuário não é admin',
      'en-US': 'Invalid login. User is not admin',
    },
    'userIsDisabled': {
      'pt-BR': 'Login invalido. Usuário desabilitado',
      'en-US': 'Invalid login. User is disabled',
    }
  },
  'user': {
    'personNotFound': {
  ...
  'invitation': {
    'invitationHasAlreadyBeenCreated': {
      'pt-BR': 'Convite já foi criado',
      'en-US': 'Invitation has already been created',
    },
    'invitationSent': {
