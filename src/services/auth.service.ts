...
import {InviteRepository, PersonRepository, UserRepository} from '../repositories';
...
export class AuthService {
  ...
  public async createUser(authToken: string, uniqueId: string, birthday: Date): Promise<SumaryUser> {
    ...
    const updatedUser = await this.userRepository.updateById(tokenDecoded.id, {personId: person._id, projects, inviters});
    return {
