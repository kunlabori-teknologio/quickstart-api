...
export class __PermissionRepository extends DefaultCrudRepository<
  ...
  __PermissionRelations
> {
  public readonly permissionActions: HasManyThroughRepositoryFactory<
    __PermissionAction,
  ...
  constructor(
    ...
    @repository.getter('__PermissionHasActionsRepository')
    protected permissionHasActionsRepositoryGetter: Getter<__PermissionHasActionsRepository>,
    @repository.getter('__PermissionActionRepository')
    protected permissionActionRepositoryGetter: Getter<__PermissionActionRepository>,
    @repository.getter('__ModuleRepository')
    protected moduleRepositoryGetter: Getter<__ModuleRepository>,
    ...
    this.permissionActions = this.createHasManyThroughRepositoryFactoryFor(
      'permissionActions',
      permissionActionRepositoryGetter,
      permissionHasActionsRepositoryGetter,
    );
    this.registerInclusionResolver(
      'permissionActions',
      this.permissionActions.inclusionResolver,
    );
  }
}
