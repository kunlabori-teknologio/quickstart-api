...
> {
  ...
  public readonly permissionGroups: HasManyThroughRepositoryFactory<
    __PermissionGroup,
  ...
  constructor(
    ...
    protected companyRepositoryGetter: Getter<__CompanyRepository>,
    @repository.getter('__UserHasPermissionGroupsRepository')
    protected userHasPermissionGroupsRepositoryGetter: Getter<__UserHasPermissionGroupsRepository>,
    ...
    this.permissionGroups = this.createHasManyThroughRepositoryFactoryFor(
      'permissionGroups',
      permissionGroupRepositoryGetter,
      userHasPermissionGroupsRepositoryGetter,
    );
    this.registerInclusionResolver(
      'permissionGroups',
      this.permissionGroups.inclusionResolver,
    );
    ...
    this.person = this.createHasOneRepositoryFactoryFor(
      'person',
