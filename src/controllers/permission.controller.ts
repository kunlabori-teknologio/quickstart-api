...
export class PermissionController {
  ...
  @authenticate({strategy: 'autentikigo', options: {collection: 'Permission', action: 'read'}})
  @get('/permissions')
  @response(200, {
  ...
  @authenticate({strategy: 'autentikigo', options: {collection: 'Permission', action: 'readOne'}})
